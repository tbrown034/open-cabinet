      ...
      {summary ? (
        <>
          <p className="text-neutral-600 leading-relaxed mb-4">
            ...
            {" "}({share} percent) are checked on their trade columns: type, date, amount and late flag. Checked means an independent program or a second company&rsquo;s model read the same four values, and a third company&rsquo;s model, shown the row, confirmed it against the page image; or a person compared the row to the page. This status describes the trade columns. Company names and ticker symbols have separate checks; a public ticker also requires a matching independent name read or a recorded human decision.
          </p>
