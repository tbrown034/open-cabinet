...
const ABBREVIATIONS: Record<string, string> = {
  // Each entry is one long spelling of one short form. Words whose short
  // form could also be a different word (TECH for both Technology and
  // Technologies: Tetra Tech and Tetra Technologies are two issuers,
  // Codex Sep 7) are deliberately absent, as are singular/plural pairs.
  INTERNATIONAL: "INTL", LABORATORIES: "LABS", COMPANIES: "COS", SERVICES: "SVCS", FINANCIAL: "FINL", PAYMENTS: "PMTS",
  ASSOCIATES: "ASSOC", COMMUNICATIONS: "COMM", ENTERTAINMENT: "ENTMT", INDUSTRIES: "INDS", MANUFACTURING: "MFG",
  CORPORATION: "CORP", INCORPORATED: "INC", INSTRUMENTS: "INSTRS", NATIONAL: "NATL", AMERICAN: "AMER", MOTORS: "MTRS",
  MANAGEMENT: "MGMT", DEVELOPMENT: "DEV", PROPERTIES: "PPTYS", MEDICAL: "MED", HEALTHCARE: "HLTHCARE", HEALTH: "HLTH",
  GENERAL: "GENL", SEMICONDUCTOR: "SEMICOND", AUTOMOTIVE: "AUTO", PETROLEUM: "PETE", INSURANCE: "INS", EQUIPMENT: "EQUIP",
  INTERACTIVE: "INTERACTV",
};
