...
| Transactions | 11,502 |
| Rows under review (not counted in totals) | 12 |
...
Rows by verification state: 11,318 checked; 77 human_verified; 0 deterministic_agree; 0 two_models_agree; 93 audit_only; 14 single_read; 12 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
