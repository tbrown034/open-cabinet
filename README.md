...
Rows by verification state: 4,652 checked; 3 human_verified; 1,523 deterministic_agree; 13 two_models_agree; 165 audit_only; 4,019 single_read; 1,126 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
