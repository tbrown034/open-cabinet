...
Rows by verification state: 4,652 checked; 4 human_verified; 1,523 deterministic_agree; 13 two_models_agree; 165 audit_only; 4,016 single_read; 1,127 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
