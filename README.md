...
| Transactions | 11,484 |
| Rows under review (not counted in totals) | 16 |
...
Rows by verification state: 10,896 checked; 37 human_verified; 0 deterministic_agree; 0 two_models_agree; 91 audit_only; 460 single_read; 16 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
