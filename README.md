...
| Transactions | 11,493 |
| Rows under review (not counted in totals) | 21 |
...
Rows by verification state: 11,254 checked; 74 human_verified; 0 deterministic_agree; 0 two_models_agree; 91 audit_only; 74 single_read; 21 disputed. Counts are checked against `data/meta/row-verification.json` at test time.
